...
void BoxForceScene::Update()
{
	...
	{
		static_cast<PxRigidBody*>(m_pCube->GetRigidActor())->addForce(PxVec3(-amountOfForce, 0.f, 0.f), PxForceMode::eACCELERATION);
	}
	...
	{
		static_cast<PxRigidBody*>(m_pCube->GetRigidActor())->addForce(PxVec3(0.f, 0.f, amountOfForce), PxForceMode::eACCELERATION);
	}
