...
void SpikeGenerator(triangle VS_DATA vertices[3], inout TriangleStream<GS_DATA> triStream)
{
	...
	//Step 4 + 5. Calculate Individual Face Normals (Cross Product of Face Edges) & Create Vertices for every face
        ...
        //FACE 1
        float3 faceNormal1 = normalize(cross(vertices[0].Position - vertices[1].Position, basePoint - vertices[1].Position));
        ...
        //FACE 2
        float3 faceNormal2 = normalize(cross(vertices[1].Position - vertices[2].Position, basePoint - vertices[2].Position));
        ...
        //Face 3
        float3 faceNormal3 = normalize(cross(vertices[2].Position - vertices[0].Position, basePoint - vertices[0].Position));
