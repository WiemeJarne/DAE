...
void FontTestScene::Initialize()
{
	...
	m_pFontConsolas48 = ContentManager::Load<SpriteFont>(L"SpriteFonts/Consolas_32.fnt");
}

void FontTestScene::Update()
{
	TextRenderer::Get()->DrawText(m_pFontConsolas48, StringUtil::utf8_decode(m_Text), m_TextPosition, m_TextColor);
}
