...
void DrawBeam()
{
	...
	FillRect(g_WindowWidth - squareSize - border, g_WindowHeight - squareSize - border, squareSize, squareSize);

	SetColor(1.f, 1.f, 1.f, 1.f);
	DrawRect(border, border, squareSize, squareSize);
	DrawRect(g_WindowWidth - squareSize - border, g_WindowHeight - squareSize -border, squareSize, squareSize);
