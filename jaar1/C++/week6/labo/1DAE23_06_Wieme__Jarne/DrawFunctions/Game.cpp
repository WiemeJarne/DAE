...
void Draw()
{
	...
	Rectf rectangle{ 10, 300, 200, 20 };
	DrawLinearGradient(rectangle, black, white);

	rectangle.bottom = 260;
	rectangle.width = 300;
	rectangle.height = 30;
	...
	rectangle.bottom = 155;
	rectangle.width = 550;
	rectangle.height = 50;
	DrawLinearGradient(rectangle, blue, yellow);

	Point2f middlePointBottomLeftDot{ 50,50 };
	DrawDotGrid(middlePointBottomLeftDot, 15, 3, 3, 5, red);

	middlePointBottomLeftDot.x = 300;
	DrawDotGrid(middlePointBottomLeftDot, 10, 3, 2, 7, green);
	DrawDotGrid(middlePointBottomLeftDot, 5, 13, 2, 7, blue);
}
