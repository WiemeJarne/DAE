...
//Name: tree.ma
//Last modified: Fri, May 06, 2022 04:44:34 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "7F66E164-4DD7-B658-65C7-B8B934D84480";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "CBB20537-40F8-A23F-4B21-26837A14FFF1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -521.13418004712912 202.44644768681914 257.72242740715967 ;
	setAttr ".r" -type "double3" -11.138352669044224 -2943.0000000002683 1.7514434130876277e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 562.35550770698524;
...
createNode transform -n "polySurface14";
	...
	setAttr ".r" -type "double3" 149.59315981234812 51.962990442891545 -207.6493368545045 ;
...
createNode transform -n "polySurface18";
	...
	setAttr ".r" -type "double3" -175.66675781446011 -10.139484512445229 -438.89603322607053 ;
...
createNode transform -n "polySurface23";
	...
	setAttr ".t" -type "double3" -8.0165969557809706 193.32293046142769 -14.000271585986706 ;
	setAttr -av ".ty";
	setAttr ".r" -type "double3" -67.988035569517635 -262.93297728711019 -33.497504945504666 ;
	setAttr ".s" -type "double3" 7.2933271103102104 19.647438547707903 7.2933271103102104 ;
	setAttr ".rp" -type "double3" 11.103476633873655 -1.0098408131622225 15.785694896533936 ;
	setAttr ".sp" -type "double3" 5.1626763343811026 -0.1742964684963226 7.3397221565246573 ;
	setAttr ".spt" -type "double3" 5.940800299492552 -0.8355443446659 8.4459727400092781 ;
...
createNode transform -n "polySurface30";
	...
	setAttr ".t" -type "double3" -2.0379405771220052 199.36661962308921 -16.429032135649756 ;
	setAttr ".r" -type "double3" -241.75028592390177 -798.74207910380051 -853.34776118724471 ;
	setAttr ".s" -type "double3" 8.7150472231112062 23.477399569037996 8.7150472231112062 ;
	setAttr ".rp" -type "double3" 0.93026403379546274 -3.4983656387505717 16.130407827326152 ;
	setAttr ".sp" -type "double3" 0.43253588676452615 -0.60381078720092762 7.4999999999999991 ;
	setAttr ".spt" -type "double3" 0.4977281470309366 -2.894554851549644 8.6304078273261506 ;
...
createNode transform -n "polySurface31";
	...
	setAttr ".rp" -type "double3" -0.6729950332001664 118.87250030744569 -0.99800245078490946 ;
	setAttr ".sp" -type "double3" -0.6729950332001664 118.87250030744569 -0.99800245078490946 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9E41253B-43E1-282D-B7F6-209D53622A9F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C368BEC4-4FEC-1152-E022-548609448132";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "463BC403-49CB-DA1D-394C-8BA29EC93BAD";
createNode displayLayerManager -n "layerManager";
	rename -uid "EA8C5A4B-4D67-6F31-E489-6E96D30DDAFE";
createNode displayLayer -n "defaultLayer";
	rename -uid "45D86949-4101-3F2D-C3A0-C8B00BB0C9F2";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DABF7A28-4014-806D-CFE1-0C91E6515577";
