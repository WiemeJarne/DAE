...
//Name: Lab_Texturing.0005.ma
//Last modified: Fri, Mar 25, 2022 09:44:13 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "3A6CD88F-4FB4-4E01-347F-44AFE6650CED";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 197.38610414504279 44.486569321683902 192.64991540954495 ;
	setAttr ".r" -type "double3" -5.7383527305053672 408.19999999995423 -5.9647406979856897e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 203.71722701746651;
