...
//Name: Lab_Texturing.0001.ma
//Last modified: Fri, Mar 25, 2022 08:49:13 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "11DC003F-434E-8585-92CC-A3A806DD67D5";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.272026783459317 185.41928739417003 344.50293103032402 ;
	setAttr ".r" -type "double3" -28.538352731335937 1089.799999999424 8.0691323013362282e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 400.06215278848526;
...
createNode mesh -n "polySurfaceShape3" -p "polySurface2";
	...
	setAttr -k off ".v";
	setAttr ".iog[0].og[0].gcl" -type "componentList" 45 "f[0:44]" "f[1]" "f[2]" "f[3]" "f[4]" "f[5]" "f[6]" "f[7]" "f[8]" "f[9]" "f[10]" "f[11]" "f[12]" "f[13]" "f[14]" "f[15]" "f[16]" "f[17]" "f[18]" "f[19]" "f[20]" "f[21]" "f[22]" "f[23]" "f[24]" "f[25]" "f[26]" "f[27]" "f[28]" "f[29]" "f[30]" "f[31]" "f[32]" "f[33]" "f[34]" "f[35]" "f[36]" "f[37]" "f[38]" "f[39]" "f[40]" "f[41]" "f[42]" "f[43]" "f[44]";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
