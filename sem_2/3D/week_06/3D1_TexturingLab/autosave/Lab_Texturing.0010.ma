...
//Name: Lab_Texturing.0010.ma
//Last modified: Fri, Mar 25, 2022 10:40:56 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "6B2761E4-43B9-554F-91E7-6E9AE6FD05FA";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 66.178082869689817 140.37711484854987 282.60469595786759 ;
	setAttr ".r" -type "double3" -12.938352730100261 -347.00000000003666 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 312.00212198824357;
...
connectAttr "aiStandardSurface3SG.mwc" "polySurfaceShape5.iog.og[0].gco";
...
connectAttr "polySurfaceShape5.iog.og[0]" "aiStandardSurface3SG.dsm" -na;
