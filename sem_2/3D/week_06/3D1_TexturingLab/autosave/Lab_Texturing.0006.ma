...
//Name: Lab_Texturing.0006.ma
//Last modified: Fri, Mar 25, 2022 09:49:13 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "0C395C9E-46EE-FA53-4208-EBB09A05848D";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -161.79703654642262 174.45568737940349 319.80686542269689 ;
	setAttr ".r" -type "double3" -27.338352730509811 324.5999999998661 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 312.00212198879632;
