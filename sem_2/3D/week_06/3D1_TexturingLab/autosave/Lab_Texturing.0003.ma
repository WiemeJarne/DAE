...
//Name: Lab_Texturing.0003.ma
//Last modified: Fri, Mar 25, 2022 09:29:13 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "D1608AFC-417B-E794-9D3A-63802E6451CF";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 336.41254686077099 324.08335180302788 129.15285714428518 ;
	setAttr ".r" -type "double3" -34.538352730889329 1152.2000000005835 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 474.98999314578907;
...
createNode psdFileTex -n "psdFileTex1";
	...
	setAttr ".cs" -type "string" "sRGB";
	setAttr ".lsn" -type "string" "Color Fill 1";
