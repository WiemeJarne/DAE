...
//Name: Lab_Texturing.0004.ma
//Last modified: Fri, Mar 25, 2022 09:34:13 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "E8123E34-4274-9772-9B22-DF8BDF90542A";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 169.34506411444445 223.68038350693973 164.67369386300408 ;
	setAttr ".r" -type "double3" -47.738352730582243 1138.9999999998183 -6.1753777757153022e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 384.38840975125447;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 56.943685507600847 49.278189381577675 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "1ACEF960-4BA4-CD62-DBEB-24989CB89CFF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 412.84171993010631;
...
createNode mesh -n "polySurface2Shape" -p "|polySurface2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.50640999898314476 0.37182917911559343 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 56 ".pt[0:55]" -type "float3"  15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		...
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 15.990118 
		0 62.289856 15.990118 0 62.289856 15.990118 0 62.289856 0 0 -59.034763 0 0 -59.034763 
		0 0 -59.034763 0 0 -59.034763 0 0 -59.034763 0 0 -59.034763 0 0 -59.034763 0 0 -59.034763;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode psdFileTex -n "psdFileTex1";
	...
	setAttr ".cs" -type "string" "sRGB";
	setAttr ".lsn" -type "string" "Group 1";
...
connectAttr "polyUnite1.out" "polySurface2Shape.i";
...
connectAttr "polySurface2Shape.iog" "aiStandardSurface3SG.dsm" -na;
