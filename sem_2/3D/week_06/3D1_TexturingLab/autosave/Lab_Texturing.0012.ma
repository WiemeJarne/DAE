...
//Name: Lab_Texturing.0012.ma
//Last modified: Fri, Mar 25, 2022 10:50:56 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "9F4E3138-459F-F14A-0834-C9845A276399";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -96.942696839052189 244.79900393501282 -489.14138892161759 ;
	setAttr ".r" -type "double3" -27.938352717219956 -893.399999999751 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 477.12988532152889;
