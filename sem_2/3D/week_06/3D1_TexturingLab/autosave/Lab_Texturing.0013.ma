...
//Name: Lab_Texturing.0013.ma
//Last modified: Fri, Mar 25, 2022 10:55:56 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "5BE566BB-443B-4DA0-AB42-52B046B13167";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "DB7CFA40-4A03-289C-89C1-A79DBD07BBBA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -236.64900777868345 405.73427516382537 417.64168015304159 ;
	setAttr ".r" -type "double3" -41.138352717127106 -1103.0000000003331 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "12DBCC36-4319-2405-1C40-2094631A0C59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 477.1298853303997;
