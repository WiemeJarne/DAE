...
Explosion::Explosion(const Point2f& bottomLeftPos, float scale, ExplosionType explosionType)
	...
	, m_pSprite{ }
{
	...
	{
		m_pSprite = new Sprite{ "Resources/Explosions/Explosion3.png", Sprite::AnimType::dontRepeat, 6, 1, 7.f };
	}
	else if (m_ExplosionType == ExplosionType::EnemyBulletExplosion)
	{
		m_pSprite = new Sprite{ "Resources/Explosions/Explosion1.png", Sprite::AnimType::dontRepeat, 5, 1, 7.f };
	}
}
