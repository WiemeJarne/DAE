...
void EmptyLinkFunctionForGeneratedCodeUE4Demo_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_UE4Demo()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_UHealthComponent_OnDeathSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UHealthComponent_OnDamageSignature__DelegateSignature,
			};
